        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 gap-4 p-4">
          {images.map((src, index) => (
            <div
              ...
              className="cursor-pointer w-full h-full sm:border-0 border border-[#b3b3b3] sm:rounded-none rounded-[12px]"
            >
              <img
                src={src}
                alt={`Image ${index + 1}`}
                className="w-full h-full sm:rounded-none rounded-[12px]"
              />
            </div>
          ))}
